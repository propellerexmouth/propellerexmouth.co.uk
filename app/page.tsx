  ...
  return (
    <div className="bg-white w-full">
      <div className=" max-w-6xl px-6 mx-auto  overflow-hidden">
        <div className="flex">
          <div className=" mt-20 w-full h-full px-3 py-20 relative overflow-hidden block z-10 mr-2 before:absolute before:inset-0 before:z-[-10] before:block before:w-full before:h-full before:bg-primary-900"></div>
          <div className="mt-20 w-full h-full px-4 py-28 relative overflow-hidden block z-10 mr-2 before:absolute before:inset-0 before:z-[-10] before:block before:w-full before:h-full before:bg-primary-900"></div>
